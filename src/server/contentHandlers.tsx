...
import { formatCodeForReposList, formatCodeForCommitsContent, formatCodeForFileContent, formatCodeForFileTable }from './formatters';
...
export async function showFilesInfo(endpoint: string, hash: string): Promise<object> {
  ...
  let result: Array<object> | object;
...
export async function showFileContent(repositoryPath: string, hash: string, fileName: string): Promise<object> { 
  let result: object; 
